            ...
            <div className="flex min-h-screen items-center justify-center p-4 text-center sm:p-0">
                <div className="relative transform overflow-hidden rounded-[2rem] bg-white dark:bg-slate-950 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-md animate-in fade-in zoom-in duration-300 border border-slate-200 dark:border-slate-800">
                    ...
                    <button 
                        onClick={onClose}
                        disabled={isLoading}
                        className="absolute right-6 top-6 p-2 rounded-full text-slate-400 hover:text-slate-600 hover:bg-slate-100 dark:hover:bg-slate-900 transition-all duration-200"
                    >
                    ...
                    <div className="px-8 pt-10 pb-8">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <div className="space-y-3">
                                <h3 className="text-xl font-bold text-slate-900 dark:text-white leading-tight" id="modal-title">
                                    {title}
                                </h3>
                    ...
                    <div className="px-8 pb-10 flex flex-col sm:flex-row-reverse gap-3">
                        ...
                        <button
                            type="button"
                            className="inline-flex items-center justify-center rounded-2xl bg-slate-50 dark:bg-slate-900 px-6 py-3.5 text-sm font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-200 w-full sm:w-auto group border border-slate-200 dark:border-slate-800"
                            onClick={onClose}
                            disabled={isLoading}
                        >
                            {cancelText}
